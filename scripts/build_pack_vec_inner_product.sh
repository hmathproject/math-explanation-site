#!/bin/bash
# build_pack_vec_inner_product.sh — ベクトル・内積と図形単元 パック PDF を生成する
#
# 使い方:
#   cd experiments/graph-guided-lessons/site
#   bash scripts/build_pack_vec_inner_product.sh
#
# 出力: site/assets/pdf/vec-inner-product-pack.pdf
...
P1="$ROOT/pdf/ベクトル_内積の意味_integrated_exp.pdf"
P2="$ROOT/pdf/ベクトル_垂直条件_integrated_exp.pdf"
P3="$ROOT/pdf/ベクトル_なす角と長さ_integrated_exp.pdf"
OUT_DIR="$SITE_DIR/assets/pdf"
OUT="$OUT_DIR/vec-inner-product-pack.pdf"
