#!/bin/bash
# build_pack_seq_pattern.sh — 数列・階差数列と群数列単元 パック PDF を生成する
#
# 使い方:
#   cd experiments/graph-guided-lessons/site
#   bash scripts/build_pack_seq_pattern.sh
#
# 出力: site/assets/pdf/seq-pattern-pack.pdf
...
P1="$ROOT/pdf/数列_階差数列_integrated_exp.pdf"
P2="$ROOT/pdf/数列_群数列_integrated_exp.pdf"
OUT_DIR="$SITE_DIR/assets/pdf"
OUT="$OUT_DIR/seq-pattern-pack.pdf"
