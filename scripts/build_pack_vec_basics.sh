#!/bin/bash
# build_pack_vec_basics.sh — ベクトル・ベクトルの基本単元 パック PDF を生成する
#
# 使い方:
#   cd experiments/graph-guided-lessons/site
#   bash scripts/build_pack_vec_basics.sh
#
# 出力: site/assets/pdf/vec-basics-pack.pdf
...
P1="$ROOT/pdf/ベクトル_ベクトルとは_integrated_exp.pdf"
P2="$ROOT/pdf/ベクトル_加法と減法_integrated_exp.pdf"
P3="$ROOT/pdf/ベクトル_実数倍と平行_integrated_exp.pdf"
OUT_DIR="$SITE_DIR/assets/pdf"
OUT="$OUT_DIR/vec-basics-pack.pdf"
