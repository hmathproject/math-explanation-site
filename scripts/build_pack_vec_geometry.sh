#!/bin/bash
# build_pack_vec_geometry.sh — ベクトル・位置ベクトルと図形単元 パック PDF を生成する
#
# 使い方:
#   cd experiments/graph-guided-lessons/site
#   bash scripts/build_pack_vec_geometry.sh
#
# 出力: site/assets/pdf/vec-geometry-pack.pdf
...
P1="$ROOT/pdf/ベクトル_位置ベクトル_integrated_exp.pdf"
P2="$ROOT/pdf/ベクトル_内分と外分_integrated_exp.pdf"
P3="$ROOT/pdf/ベクトル_図形条件のベクトル式化_integrated_exp.pdf"
OUT_DIR="$SITE_DIR/assets/pdf"
OUT="$OUT_DIR/vec-geometry-pack.pdf"
