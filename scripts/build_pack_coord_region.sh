#!/bin/bash
# build_pack_coord_region.sh — 図形と方程式・領域単元 パック PDF を生成する
#
# 使い方:
#   cd experiments/graph-guided-lessons/site
#   bash scripts/build_pack_coord_region.sh
#
# 出力: site/assets/pdf/coord-region-pack.pdf
...
P1="$ROOT/pdf/図形と方程式_不等式と領域_integrated_exp.pdf"
P2="$ROOT/pdf/図形と方程式_連立不等式と領域_integrated_exp.pdf"
P3="$ROOT/pdf/図形と方程式_領域と最大最小_integrated_exp.pdf"
OUT_DIR="$SITE_DIR/assets/pdf"
OUT="$OUT_DIR/coord-region-pack.pdf"
