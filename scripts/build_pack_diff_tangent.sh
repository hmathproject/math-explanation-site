#!/bin/bash
# build_pack_diff_tangent.sh — 微分・接線と法線単元 パック PDF を生成する
#
# 使い方:
#   cd experiments/graph-guided-lessons/site
#   bash scripts/build_pack_diff_tangent.sh
#
# 出力: site/assets/pdf/diff-tangent-pack.pdf
...
P1="$ROOT/pdf/微分_接線の方程式_integrated_exp.pdf"
P2="$ROOT/pdf/微分_曲線外からの接線_integrated_exp.pdf"
P3="$ROOT/pdf/微分_法線の方程式_integrated_exp.pdf"
OUT_DIR="$SITE_DIR/assets/pdf"
OUT="$OUT_DIR/diff-tangent-pack.pdf"
