#!/bin/bash
# build_pack_seq_basics.sh — 数列・数列の基本単元 パック PDF を生成する
#
# 使い方:
#   cd experiments/graph-guided-lessons/site
#   bash scripts/build_pack_seq_basics.sh
#
# 出力: site/assets/pdf/seq-basics-pack.pdf
...
P1="$ROOT/pdf/数列_等差数列_integrated_exp.pdf"
P2="$ROOT/pdf/数列_等比数列_integrated_exp.pdf"
P3="$ROOT/pdf/数列_一般項と和の関係_integrated_exp.pdf"
OUT_DIR="$SITE_DIR/assets/pdf"
OUT="$OUT_DIR/seq-basics-pack.pdf"
