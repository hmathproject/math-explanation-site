#!/bin/bash
# build_pack_coord_circle.sh — 図形と方程式・円の方程式単元 パック PDF を生成する
#
# 使い方:
#   cd experiments/graph-guided-lessons/site
#   bash scripts/build_pack_coord_circle.sh
#
# 出力: site/assets/pdf/coord-circle-pack.pdf
...
P1="$ROOT/pdf/図形と方程式_円の方程式_integrated_exp.pdf"
P2="$ROOT/pdf/図形と方程式_円と直線_integrated_exp.pdf"
P3="$ROOT/pdf/図形と方程式_接線の方程式_integrated_exp.pdf"
OUT_DIR="$SITE_DIR/assets/pdf"
OUT="$OUT_DIR/coord-circle-pack.pdf"
