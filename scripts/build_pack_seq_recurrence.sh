#!/bin/bash
# build_pack_seq_recurrence.sh — 数列・漸化式単元 パック PDF を生成する
#
# 使い方:
#   cd experiments/graph-guided-lessons/site
#   bash scripts/build_pack_seq_recurrence.sh
#
# 出力: site/assets/pdf/seq-recurrence-pack.pdf
...
P1="$ROOT/pdf/数列_基本型漸化式_integrated_exp.pdf"
P2="$ROOT/pdf/数列_1次変換型漸化式_integrated_exp.pdf"
P3="$ROOT/pdf/数列_Σ型漸化式_integrated_exp.pdf"
OUT_DIR="$SITE_DIR/assets/pdf"
OUT="$OUT_DIR/seq-recurrence-pack.pdf"
